...
Write-Host ""
Write-Host "Setting up Epic FHIR Bridge..." -ForegroundColor Yellow

Set-Location "..\epic-fhir-bridge"

# Install Bridge dependencies
Write-Host "Installing Bridge dependencies..."
npm install --silent

Write-Host "✅ Epic FHIR Bridge setup complete" -ForegroundColor Green
